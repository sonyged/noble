...
NobleBindings.prototype.onDisconnected = function(event) {
    this.emit('disconnect', event.target.id);
};
...
NobleBindings.prototype.connect = function(deviceUuid) {
  ...
  peripheral.device.addEventListener('gattserverdisconnected', this.onDisconnected);
...
NobleBindings.prototype.disconnect = function(deviceUuid) {
  ...
  peripheral.device.removeEventListener('gattserverdisconnected', this.onDisconnected);
